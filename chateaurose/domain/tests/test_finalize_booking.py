    ...
    assert notifier.messages == [
        {
            ...
            "body": "\n".join(
                [
                    ...
                    "- Reste à régler directement au salon/prestataire : 59,50 €",
                    "",
    ...
    assert notifier.messages[-2:] == [
        {
            ...
            "body": "\n".join(
                [
                    ...
                    "- Reste à régler directement au salon/prestataire après confirmation : 59,50 €",
                    "",
                    "À bientôt,",
                    "L'équipe Château Rose",
                ]
    ...
    assert notifier.messages == [
        {
            ...
            "body": "\n".join(
                [
                    ...
                    "- Reste à régler directement au salon/prestataire après confirmation : 63,00 €",
                    "",
                    "À bientôt,",
                    "L'équipe Château Rose",
                ]
