...
class ServicePagesTests(TestCase):
    ...
    def test_home_hero_uses_service_polaroids_as_primary_ctas(self):
        response = self.client.get(reverse("interface:home"))
    ...
    def test_enabled_generic_booking_redirects_to_recap_then_creates_booking(self):
        ...
        self.assertTemplateUsed(recap_page, "interface/generic_booking_recap.html")
        self.assertContains(recap_page, "Tresses / Braids · Knotless braids")
        self.assertContains(recap_page, "Nous recherchons une coiffeuse compatible")
